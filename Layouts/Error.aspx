<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Error.aspx.cs" Inherits="RockWeb.Themes.NextGenStarter.Layouts.Error" %>
...
<head runat="server">
    ...
    <%--
        The error page is a plain System.Web.UI.Page (not a RockPage), so the
        theme-relative "~~/" prefix is not available here — the path must name
        the theme folder. If you rename the theme folder, update this path.
    --%>
    <link rel="stylesheet" href="<%= Page.ResolveUrl("~/Themes/NextGenStarter/Styles/theme.css") %>" />
